...
import { httpApiPPPD, formatDate, httpApiGet } from "../../lib";
...
const TipoClientePage = () => {
    ...
    const [tituloBoton, setTituloBoton] = useState("Mostrar los tipos de identificación");
    ...
    const verListado = async () => {
        ...
        setTituloBoton(!estadosVisibles ? "Ocultar los tipos de identificación" : "Mostrar los tipos de identificación");
    ...
    const OnbtnGuardar = async () => {
        ...
        if (((apiError.nombre) && (apiError.nombre?.length > 0)) || ((apiError.descripcion) && (apiError.descripcion?.length > 0))){
            ...
            if (btnRef === "Guardar"){
                ...
                const response = await httpApiPPPD("PosTipoIdCliente", "POST", {
                ...
                if (response.statusCode >= 400){
                    ...
                    msg = "Se ha creado la identificación exitosamente!!!"
                ...
                const response = await httpApiPPPD(`PosTipoIdCliente/${frmData.id}/${frmData.nombre}`, "PUT", {
                    "Content-Type" : "application/json"
                }, frmData);
                if (response.statusCode >= 400){
                    setOperacion(false);
                    ...
                    msg = "Se ha actualizado la identificación exitosamente!!!"
                    mensajeModal.push(msg);
                    OnbtnLimpiar();
                }  
            }
            ...
            <div className=' vh-100 ms-5 me-5 border rounded-3 shadow'>
                ...
                <div  className=' d-flex justify-content-evenly align-items-center bg-body-tertiary'>
                    <div className="border p-1 rounded w-100" style={{"color": "#2A3482"}}>
                        <a id="inicio"></a>
                        <label htmlFor="" className="h3 p-2 m-2">Tipo de identificación</label>
                        <form className='row border p-2 m-2'>
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-3">
                                <label htmlFor="nombre" className="form-label">* Nombre Identificación</label>                
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12 mb-3">
                                <label htmlFor="direccion" className="form-label">Descripción de la identificación </label>                  
                    ...
                    { showYesNo && <MsgYesNoDialog
                            ...
                            Message={`Este proceso cambia el estado del tipo de identificación, lo deshabilita si está habilitado o visceversa. ¿Quiero cambiarlo?`}
                            Icon='X'
