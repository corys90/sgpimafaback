...
const ProductoCompuesto = () => {
    ...
    const verListado = async () => {
        ...
        setTituloBoton(!estadosVisibles ? "Ocultar productos compuestos" : "Mostrar productos compuesto");
    ...
    const OnbtnGuardar = async () => {
        ...
        if (((apiError.nombre) && (apiError.nombre?.length > 0)) || ((apiError.descripcion) && (apiError.descripcion?.length > 0))){
            ...
            if (btnRef === "Guardar"){
                ...
                const response = await httpApiPPPD("PosProductoCompuesto", "POST", {
                ...
                if (response.statusCode >= 400){
                    ...
                    msg = "Se ha creado la unidad de medida exitosamente!!!"
                ...
                const response = await httpApiPPPD(`PosProductoCompuesto/${frmData.id}/${frmData.nombre}`, "PUT", {
                    "Content-Type" : "application/json"
                }, frmData);
                if (response.statusCode >= 400){
                    setOperacion(false);
                    ...
                    msg = "Se ha actualizado la unidad de medida exitosamente!!!"
                    mensajeModal.push(msg);
                    OnbtnLimpiar();
                }  
            }
            ...
            <div className=' vh-100 ms-5 me-5 border rounded-3 shadow'>
                ...
                <div  className=' d-flex justify-content-evenly align-items-center bg-body-tertiary'>
                    <div className="border p-1 rounded w-100" style={{"color": "#2A3482"}}>
                        <a id="inicio"></a>
                        <label htmlFor="" className="h3 p-2 m-2">Composición de prodcuctos</label>
                        <form className='row border p-2 m-2'>
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-3">
                                <label htmlFor="nombre" className="form-label">* Nombre de la composición</label>                
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12 mb-3">
                                <label htmlFor="direccion" className="form-label">Descripción de la composición</label>                  
                        ...
                        estadosVisibles && (
                                <div className="ms-2 mt-3 p-2 border rounded">          
                                    <DataTable 
                                        title="Composición de prodcuctos"
                    ...
                    { showYesNo && <MsgYesNoDialog
                            Title='Tipos de Propductos compuestos'
                            Message={`Este proceso cambia el estado del producto compuesto, lo deshabilita si está habilitado o visceversa. ¿Quiero cambiarlo?`}
                            Icon='X'
